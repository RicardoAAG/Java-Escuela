...
public class tiendaderopascroll extends JFrame implements ActionListener,ItemListener{
	...
	public tiendaderopascroll(){
		...
		scroll=new JScrollPane(recibo);
		scroll.setBounds(10,270,360,150);
		add(scroll);
	...
	public static void main(String[] args) {
		tiendaderopascroll ventana=new tiendaderopascroll();
